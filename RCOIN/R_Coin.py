...
def mine_block():
    ...
    # adding the tran
    blockchain.add_transactions(sender = node_address, receiver= 'Pandas', amount=1)
...
def add_transactions():
    ...
    transaction_keys = ['sender', 'receciver', 'amount']
    if not all( key in json for key in transaction_keys):
        return 'Some elements(keys) of tran are missing', 400
    # index of next block
    index = blockchain.add_transactions(json['sender'], json['receciver'], json['amount'])
